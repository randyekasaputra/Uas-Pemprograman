        ...
        if (!in_array(strtolower($filetype), $allowed)) {
            ...
            if (move_uploaded_file($_FILES['payment_proof']['tmp_name'], $upload_path)) {
                try {
                    ...
                    // Simpan ID pembayaran ke session untuk cetak struk
                    $_SESSION['payment_id'] = $db->lastInsertId();
                    $_SESSION['success'] = "Bukti pembayaran berhasil diunggah dan sedang menunggu verifikasi.";
                    header("Location: struk_pembayaran.php?payment_id=" . $_SESSION['payment_id']);
                    exit();
